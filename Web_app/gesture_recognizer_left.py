...
class GestureRecognizerLeft:
    ...
    def main(self, mod):
        ...
        try:
            ...
            if mod == 2:
                st.title("Complete - Left version")
            elif mod == 1:
                st.title("Semplified - Left version")
            ...
            print(mod)
            if (mod == 1):
                model = "gesture_recognizer_semplified_left.task"
            elif (mod == 2):
                model = "gesture_recognizer_complete_left.task"
            else:
